...
/**
 * All words, flattened across languages. Generated by `npm run fetch-words`
 * (which calls the vibeling backend API for every target language) from the
 * highlight slugs across src/SocialVideo/videos/*.json — videos/ is the single
 * source of truth. Do not edit words.generated.json by hand. Each entry becomes
 * a `Dictionary-<lang>-<slug>` composition (see src/Root.tsx).
 */
